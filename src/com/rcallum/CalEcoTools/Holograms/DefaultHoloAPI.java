...
public class DefaultHoloAPI implements HoloAPI {
    ...
    private final VoidChest voidChest;
    /*
    ...
    public DefaultHoloAPI(Location loc, VoidChest vc, String... lines) {
        this(loc, Arrays.asList(lines), vc);
    }
   
    public DefaultHoloAPI(Location loc, List<String> lines, VoidChest vc) {
        this.lines = lines;
        this.loc = loc;
